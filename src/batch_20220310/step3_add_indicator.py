...
from batch_20220310.batch_20220310_lib.constant import TICKERS_PRICE_FOLDER_COLLECTION_OF_ALL_TIME, indicator_path, START_DATE, END_DATE
from util.util_file import get_all_csv_file_in_folder


raw_price_files = get_all_csv_file_in_folder(TICKERS_PRICE_FOLDER_COLLECTION_OF_ALL_TIME)
