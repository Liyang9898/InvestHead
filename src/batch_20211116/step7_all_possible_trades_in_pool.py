...
from batch_20211116.batch_20211116_lib.constant import RAWS_TRADES_FOLDER_RUSSLL1000_OF_ALL_TIME, HIGH_PERF_TRADES_FOLDER_RUSSLL1000_OF_ALL_TIME, TICKER_RANK_FOLDER
import pandas as pd
...
path_filtered_trades = HIGH_PERF_TRADES_FOLDER_RUSSLL1000_OF_ALL_TIME
...
def ticker_elible_end_year():
    ...
    """
    raw_price_files = get_all_csv_file_in_folder(TICKER_RANK_FOLDER)
    dfs = []
