...
for ticker in tickers:
    sector_raw_path = "C:/f_data/sector/raw_day/BATS_{ticker}, 1D.csv".format(ticker=ticker)
    sector_clean_path = "C:/f_data/sector/clean_day/{ticker}_1D_fmt.csv".format(ticker=ticker)
