...
from strategy_lib.stratage_param import strat_param_swing_2150in_2150out_4percent_out
import pandas as pd
...
################################### 4 things to adjust#####################################
################################### 4 things to adjust#####################################
trader_folder = t_20210404_myswing_4percent_out
indicator_folder = indicator_20210404
ticker_set = swing_set1
strategy_param_bundle=strat_param_swing_2150in_2150out_4percent_out
################################### 4 things to adjust#####################################
################################### 4 things to adjust#####################################
