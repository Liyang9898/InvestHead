...
from strategy_lib.stratage_param import strat_param_swing_2150in_2150out_channel_exit
import pandas as pd
...
################################### 4 things to adjust#####################################
################################### 4 things to adjust#####################################
trader_folder = trade_swing_2150in_2150out_20210310_iwf_channel_out
indicator_folder = indicator_20210301
ticker_set = iwf
strategy_param_bundle=strat_param_swing_2150in_2150out_channel_exit
################################### 4 things to adjust#####################################
################################### 4 things to adjust#####################################
