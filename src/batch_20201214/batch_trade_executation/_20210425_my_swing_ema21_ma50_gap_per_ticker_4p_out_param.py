...
from strategy_lib.stratage_param import strat_param_swing_2150in_2150out_ma_gap_4p_out
import pandas as pd
...
################################### 4 things to adjust#####################################
################################### 4 things to adjust#####################################
trader_folder = t_20210425_ema21_ma50_gap_per_ticker_4p_out
indicator_folder = indicator_20210408
ticker_set = swing_set1
strategy_param_bundle=strat_param_swing_2150in_2150out_ma_gap_4p_out
################################### 4 things to adjust#####################################
################################### 4 things to adjust#####################################
