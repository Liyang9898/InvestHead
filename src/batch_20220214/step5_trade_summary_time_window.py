...
from batch_20220214.batch_20220214_lib.constant import RAWS_TRADES_FOLDER_SNP500_OF_ALL_TIME, trade_all_entry_path, \
...
def all_tickers_trade_summary_in_time_window(
    ...
    raw_files = get_all_csv_file_in_folder(RAWS_TRADES_FOLDER_SNP500_OF_ALL_TIME)
    tickers = []
