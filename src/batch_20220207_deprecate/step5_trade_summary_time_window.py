...
from batch_20220207.batch_20220207_lib.constant import RAWS_TRADES_FOLDER_RUSSLL1000_OF_ALL_TIME, trade_all_entry_path, \
    trade_consecutive_path, indicator_path, \
    trade_summary_per_ticker_path, trade_summary_all_ticker_path, \
    gen_time_window, WINDOW_SIZE, START_YEAR, END_YEAR
...
def all_tickers_trade_summary_in_time_window(
    ...
    raw_files = get_all_csv_file_in_folder(RAWS_TRADES_FOLDER_RUSSLL1000_OF_ALL_TIME)
    tickers = []
